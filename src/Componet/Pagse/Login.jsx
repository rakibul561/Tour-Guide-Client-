                    ...
                    <form onSubmit={handleLogin}>
                        <div className='mt-4'>
                            ...
                            <input
                                ...
                                autoComplete='email'
                                name='email'
                                className='block w-full px-4 py-2 0 bg-white border rounded-lg  text-black  focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300'
                                type='email'
                            />
                        </div>
